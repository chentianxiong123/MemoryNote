...
export function InstallationStepsView({
  ...
  return (
    <div className="space-y-4">
      <InstallationSteps title={``} steps={providerConfig.installationSteps} />
      ...
      <div className="flex items-center justify-between border-t border-gray-200 pt-4">
        <a
          ...
          className="hover:bg-grayAlpha-100 inline-flex items-center gap-2 rounded-md border border-gray-300 px-4 py-2 text-sm font-medium transition-colors"
        >
