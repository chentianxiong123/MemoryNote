...
See the [MCP Integration Guide](https://docs.getcore.me/providers/claude) for setup instructions.
...
- [Basic Concepts](https://docs.getcore.me/concepts/memory_graph) - Understanding CORE's memory model
- [API Reference](https://docs.getcore.me/api-reference) - Complete API documentation
- [MCP Integration](https://docs.getcore.me/providers/claude) - Connect Spaces with Claude and other tools
