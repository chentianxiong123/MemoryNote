...
var CreateIssueSchema = external_exports.object({
  ...
  labels: external_exports.array(external_exports.union([external_exports.number(), external_exports.string()])).optional().describe("Label IDs or names to associate with the issue")
});
var UpdateIssueSchema = external_exports.object({
  ...
  labels: external_exports.array(external_exports.union([external_exports.number(), external_exports.string()])).optional().describe("Label IDs or names to replace existing labels")
});
var SearchIssuesSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  q: external_exports.string().describe("Search query"),
  state: external_exports.enum(["open", "closed", "all"]).optional().default("all").describe("Issue state"),
  labels: external_exports.array(external_exports.string()).optional().describe("Filter by labels"),
  page: external_exports.number().optional().default(1).describe("Page number"),
  limit: external_exports.number().optional().default(30).describe("Results per page")
});
var ListLabelsSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  limit: external_exports.number().optional().default(100).describe("Results per page"),
  page: external_exports.number().optional().default(1).describe("Page number")
});
var CreateLabelSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  name: external_exports.string().describe("Label name"),
  color: external_exports.string().describe("Label color (e.g., #ff0000)"),
  description: external_exports.string().optional().describe("Label description")
});
var UpdateLabelSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  label_id: external_exports.number().describe("Label ID to update"),
  name: external_exports.string().optional().describe("New label name"),
  color: external_exports.string().optional().describe("New label color"),
  description: external_exports.string().optional().describe("New label description")
});
var DeleteLabelSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  label_id: external_exports.number().describe("Label ID to delete")
});
...
var UpdatePullRequestSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  pull_number: external_exports.number().describe("Pull request number"),
  title: external_exports.string().optional().describe("New PR title"),
  body: external_exports.string().optional().describe("New PR body"),
  state: external_exports.enum(["open", "closed"]).optional().describe("New state"),
  base: external_exports.string().optional().describe("New base branch")
});
var MergePullRequestSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  pull_number: external_exports.number().describe("Pull request number"),
  Do: external_exports.enum(["merge", "rebase", "rebase-merge", "squash"]).optional().default("merge").describe("Merge style"),
  MergeTitleField: external_exports.string().optional().describe("Title for the merge commit"),
  MergeMessageField: external_exports.string().optional().describe("Message for the merge commit")
});
var GetFileContentsSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  path: external_exports.string().describe("File path"),
  ref: external_exports.string().optional().describe("The name of the commit/branch/tag. Default the repository\u2019s default branch")
});
var CreateOrUpdateFileSchema = external_exports.object({
  owner: external_exports.string().describe("Repository owner"),
  repo: external_exports.string().describe("Repository name"),
  path: external_exports.string().describe("File path"),
  content: external_exports.string().describe("File content (base64 encoded or plain text)"),
  message: external_exports.string().optional().describe("Commit message"),
  branch: external_exports.string().optional().describe("Branch name. Default the repository\u2019s default branch"),
  sha: external_exports.string().optional().describe("The blob SHA of the file being replaced (required for updates)")
});
...
async function resolveLabelIds(owner, repo, labels) {
  const ids = [];
