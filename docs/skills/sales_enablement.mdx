...
description: "Create sales collateral and pitch materials for sales teams. Triggered by 'sales deck,' 'pitch deck,' 'one-pager,' 'demo script,' 'objection handling,' 'talk track,' 'sales materials,' 'help my sales team,' or 'what should I give my sales reps.'"
category: "Sales"
integrations: []
---

**Goal:** Create sales collateral (decks, one-pagers, objection docs, demo scripts, playbooks) that sales teams actually use to close deals.
...
Run on demand when the user needs to create any sales asset — pitch decks, objection handling docs, ROI calculators, demo scripts, or sales playbooks.

## Setup

Search memory for:
- "What type of sales collateral does the user need?"
- "What buyer personas are involved?"
- "What are the top objections?"

If found, use silently. If not found, ask once:

> "To create effective sales materials, I need to know: What specific asset do you need (pitch deck, one-pager, objection doc, demo script, etc.)? And who will be using it?"
