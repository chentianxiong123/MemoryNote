...
- **Planning**: you are writing a plan to the task description. Do NOT self-advance — stay in Planning until the user approves. Always send_message explaining you've written a plan and asking for approval.
...
Before creating: search_tasks first — if a matching Backlog/Planning/Working task already exists, use it.
