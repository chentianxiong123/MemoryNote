...
- If this task is complex and needs decomposition: create subtasks under this task (parentTaskId: ${linkedTask.id}) in Backlog, move this task to Waiting, then send_message to the user explaining the plan and asking for approval
